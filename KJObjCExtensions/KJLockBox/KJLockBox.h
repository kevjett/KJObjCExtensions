...
@interface KJLockbox : NSObject
    ...
    // instance of KJLockbox specifying your own key prefix, and use the appropriate instance methods
    // to store and retrieve keychain data. You can also instantiate your own instance and use the
    // default key prefix simply by calling [[KJLockbox alloc] init];
...
-(NSDate *)dateForKey:(NSString *)key DEPRECATED_MSG_ATTRIBUTE("Migrate to -unarchiveObject:forKey:");
    ...
    // using class-level methods. An internal instance of KJLockbox is instantiated for the class that
